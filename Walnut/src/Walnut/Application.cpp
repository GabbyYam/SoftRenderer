...
namespace Walnut {
    ...
    void Application::Init()
    {
        ...
        spdlog::debug("before create window");
        glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);
        m_WindowHandle = glfwCreateWindow(m_Specification.Width, m_Specification.Height, m_Specification.Name.c_str(), NULL, NULL);
        spdlog::debug("Create window done");
        //  Window Icons
        GLFWimage images[1];
        images[0].pixels = stbi_load("../Editor/resources/editor.png", &images[0].width, &images[0].height, 0, 4);  // rgba channels
