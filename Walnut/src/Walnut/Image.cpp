...
namespace Walnut {
    ...
    namespace Utils {
                                            ...
                                            uint32_t              type_bits)
        {
            ...
            vkGetPhysicalDeviceMemoryProperties(
                Application::GetPhysicalDevice(), &prop);
    ...
    void Image::SetData(const void* data)
    {
        ...
        size_t upload_size =
            m_Width * m_Height * Utils::BytesPerPixel(m_Format);
        ...
        if (!m_StagingBuffer) {
            // Create the Upload Buffer
            {
                ...
                err = vkCreateBuffer(device, &buffer_info, nullptr,
                                     &m_StagingBuffer);
                check_vk_result(err);
                VkMemoryRequirements req;
        ...
        {
            char* map = NULL;
            err = vkMapMemory(device, m_StagingBufferMemory, 0, m_AlignedSize,
                              0, (void**)(&map));
            check_vk_result(err);
        ...
        // Copy to Image
        {
            ...
            copy_barrier.subresourceRange.aspectMask =
